...
<head>
    ...
    <style>
        /* Desktop: Sidebar fixed, content scrolls normally */
...
<body class="bg-gray-50">
    ...
    <aside id="sidebar" class="sidebar-wrapper bg-black text-white flex flex-col h-screen border-r border-gray-900">
        ...
        <div class="p-2 border-b border-gray-800 flex items-center justify-between h-24">
            ...
            <button id="sidebar-close-btn" class="lg:hidden text-gray-500 hover:text-white p-2 rounded-lg hover:bg-gray-800 transition" aria-label="Fermer le menu">
        ...
        <nav class="flex-1 py-6 overflow-y-auto">
            ...
            <div class="space-y-1 px-3">
                ...
                <a href="<?= BASE_URL ?>/admin/contrats/index.php" class="flex items-center px-4 py-3 text-white hover:bg-gray-900 hover:text-orange-400 transition rounded-r-full mb-1
                    ...
                    <span class="font-medium text-sm">Prises en charge</span>
                </a>
    ...
    <div class="main-wrapper flex flex-col min-h-screen">
        ...
        <header class="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-20">
            <div class="flex items-center justify-between px-4 lg:px-6 py-4">
                <!-- Mobile Menu Button -->
                <button id="sidebar-toggle-btn" class="lg:hidden text-gray-600 hover:text-gray-900 p-2 -ml-2 mr-2 rounded-lg hover:bg-gray-100 transition" aria-label="Ouvrir le menu">

...
<!-- AJOUT : pt-20 (mobile) et md:pt-24 (desktop) pour l'espace sous le menu fixe -->
<body class="min-h-screen flex flex-col bg-slate-100 pt-20 md:pt-24">

    <!-- Navigation Principale -->
    <!-- MODIFICATION : 'sticky' remplacé par 'fixed' -->
    <nav class="bg-gray-900 shadow-lg fixed top-0 z-50 w-full border-b border-gray-800">
    ...
    <!-- AJOUT IMPORTANT : Fermeture de la balise NAV avant le MAIN -->
